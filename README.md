안녕하세요! 더 나은 코드를 탐구하며 개발 역량을 넓혀가는 **백엔드 개발자 권유민**입니다.  
...
▪️잇타(IT’s TIME) 8th Backend <sub>(25.09 ~ 26.01)</sub>    

## 🗓️ 프로젝트 
▪️<a href="https://github.com/Cockple/Cockple_BE">[콕플] 배드민턴 모임 플랫폼</a> <sub>(25.06 ~ ing)</sub>
▪️<a href="https://github.com/ITA-Loopin/loopin-be">[루핀] AI 루틴 관리 서비스 </a> <sub>(25.09 ~ ing)</sub>
▪️<a href="https://github.com/dbalsk/AnsimIbgeum">[안심입금] 금융 OSS 개선 프로젝트</a> <sub>(25.10 ~ 25.11)</sub>
▪️<a href="https://github.com/MJU-Capstone-Design-1/Jumoney_Spring_BE">[주머니] 교육형 모의투자 서비스</a> <sub>(26.02 ~ ing)</sub>   
